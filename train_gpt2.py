...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # nn is "number of heads", hs is "head size", and C (number of channels) = nh * hs
        # e.g. in GPT-2 (124), n_head=12, hs=64, so nh*hs=C=768 channels in the Transformer
        qkv = self.c_attn(x)
...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type):
        ...
        # init a huggingface/transformers_model
        ...
        # this means that we have to transpose these weights whe we import them
...
class DataLoaderLite:
    ...
    def next_batch(self):
        ...
        # if loading the next batch wold be out of bounds, reset
